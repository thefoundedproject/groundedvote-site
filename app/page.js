...
// 50 stars — one per state — scattered like the real night sky, not flag rows.
// Deconstructed patriotism: all 50 states counted, none ranked.
const STARS_50 = [
{x:3.8, y:6.2, r:1.1, o:0.14}, {x:9.1, y:3.4, r:0.8, o:0.10},
{x:15.7, y:9.8, r:1.3, o:0.17}, {x:22.4, y:4.9, r:0.9, o:0.11},
{x:28.9, y:13.6, r:1.0, o:0.13}, {x:35.3, y:6.1, r:1.2, o:0.15},
{x:41.8, y:10.4, r:0.8, o:0.10}, {x:48.2, y:3.7, r:1.1, o:0.14},
{x:54.6, y:14.8, r:0.9, o:0.11}, {x:61.0, y:7.3, r:1.3, o:0.16},
{x:67.4, y:11.5, r:0.8, o:0.10}, {x:73.8, y:4.2, r:1.0, o:0.13},
{x:80.2, y:16.9, r:1.2, o:0.15}, {x:86.6, y:8.7, r:0.8, o:0.10},
{x:93.0, y:5.1, r:1.1, o:0.14}, {x:97.4, y:18.3, r:0.9, o:0.11},
{x:1.5, y:29.7, r:0.8, o:0.09}, {x:4.2, y:44.1, r:1.0, o:0.10},
{x:2.9, y:58.6, r:0.8, o:0.08}, {x:5.1, y:72.3, r:1.1, o:0.09},
{x:3.4, y:84.8, r:0.8, o:0.07}, {x:7.3, y:91.5, r:1.0, o:0.08},
{x:95.8, y:31.4, r:0.8, o:0.09}, {x:98.1, y:47.2, r:1.0, o:0.10},
{x:96.5, y:61.8, r:0.8, o:0.08}, {x:94.2, y:75.9, r:1.1, o:0.09},
{x:97.7, y:86.4, r:0.8, o:0.07}, {x:92.3, y:93.1, r:1.0, o:0.08},
{x:18.6, y:27.3, r:0.9, o:0.09}, {x:31.2, y:34.8, r:1.1, o:0.10},
{x:44.5, y:22.1, r:0.8, o:0.09}, {x:57.9, y:31.6, r:1.0, o:0.10},
{x:71.3, y:25.4, r:0.8, o:0.09}, {x:84.7, y:33.9, r:1.2, o:0.11},
{x:13.4, y:68.7, r:0.8, o:0.07}, {x:26.8, y:78.4, r:1.0, o:0.08},
{x:40.2, y:62.5, r:0.8, o:0.07}, {x:53.6, y:82.3, r:1.1, o:0.08},
{x:67.0, y:71.8, r:0.8, o:0.07}, {x:80.4, y:79.6, r:1.0, o:0.08},
{x:19.8, y:89.4, r:0.8, o:0.07}, {x:35.6, y:93.2, r:1.0, o:0.07},
{x:51.4, y:90.7, r:0.8, o:0.07}, {x:67.2, y:94.1, r:1.1, o:0.07},
{x:83.0, y:88.5, r:0.8, o:0.07}, {x:88.6, y:21.7, r:0.9, o:0.10},
{x:46.9, y:42.3, r:0.8, o:0.08}, {x:62.7, y:50.1, r:1.0, o:0.08},
]
...
const issuePriorities = [answers[1]?.value, answers[2]?.value].filter(Boolean)
...
body: JSON.stringify({ email, answers: [], profile: { title: 'Notification signup', desc: '', next: '' }, notifyState: stateCode ?? null }),
})
} catch {}
setLoading(false)
setSubmitted(true)
...
{stateCode ? `We will email you as soon as ${stateCode} races go live on GroundedVote.` : 'We will notify you when the full platform is live.'}
</p>
</div>
)
}
...
<p style={{ color: '#5ECFA6', fontSize: 13, fontWeight: 600, margin: 0 }}>Notifying you when <strong>{stateCode}</strong> races go live</p>
</div>
)}
<input name="email" required type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="your@email.com"
...
<feTurbulence type="fractalNoise" baseFrequency="0.68 0.72" numOctaves="4" seed="14" stitchTiles="stitch" result="noise"/>
<feColorMatrix type="saturate" values="0" in="noise" result="gray"/>
</filter>
</defs>
<rect width="100%" height="100%" filter="url(#gv-grain)" opacity="0.055" fill="white"/>
{STARS_50.map((s, i) => (
<circle key={i} cx={`${s.x}%`} cy={`${s.y}%`} r={s.r} fill="#F5F0E8" opacity={s.o}/>
))}
</svg>

<div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at 20% 58%, rgba(232,168,32,0.09), transparent 52%)', pointerEvents: 'none' }} />

<div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', width: '100%', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 80, alignItems: 'center' }}>
<div>
<div style={{ width: 48, height: 2, backgroundColor: '#E8A820', marginBottom: 28, opacity: heroVisible ? 1 : 0, transition: 'opacity 0.6s 100ms' }} />
<p style={{ color: '#E8A820', fontSize: 10, fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 28, opacity: heroVisible ? 1 : 0, transition: 'opacity 0.8s 200ms' }}>GroundedVote</p>
<div style={{ overflow: 'hidden' }}>
<div style={{ fontSize: 'clamp(38px, 6vw, 72px)', fontWeight: 200, color: '#F5F0E8', lineHeight: 1.05, letterSpacing: '-0.03em', opacity: heroVisible ? 1 : 0, transform: heroVisible ? 'none' : 'translateY(100%)', transition: 'all 0.9s ease 400ms' }}>
Most Americans vote
</div>
</div>
<div style={{ overflow: 'hidden', marginTop: 2 }}>
<div style={{ fontSize: 'clamp(52px, 8.5vw, 100px)', fontWeight: 800, color: '#E8A820', lineHeight: 1.0, letterSpacing: '-0.04em', opacity: heroVisible ? 1 : 0, transform: heroVisible ? 'none' : 'translateY(100%)', transition: 'all 0.9s ease 540ms' }}>
on fear.
</div>
</div>
<p style={{ color: 'rgba(245,240,232,0.65)', fontSize: 17, lineHeight: 1.75, maxWidth: 440, marginTop: 36, opacity: heroVisible ? 1 : 0, transition: 'opacity 1.2s ease 900ms' }}>
...
<p style={{ color: 'rgba(245,240,232,0.6)', fontSize: 14, lineHeight: 1.7, maxWidth: 420, marginTop: 12, opacity: heroVisible ? 1 : 0, transition: 'opacity 1.2s ease 1100ms' }}>
...
<div style={{ border: '1px solid rgba(232,168,32,0.3)', borderRadius: 4, overflow: 'hidden', backdropFilter: 'blur(16px)', backgroundColor: 'rgba(15,27,31,0.88)' }}>
<div style={{ height: 3, width: '100%', backgroundColor: '#E8A820' }} />
<div style={{ padding: '36px 40px' }}>
<p style={{ color: '#E8A820', fontSize: 9, fontWeight: 800, letterSpacing: '0.25em', textTransform: 'uppercase', marginBottom: 18 }}>Before We Build This For You</p>
<h3 style={{ color: '#F5F0E8', fontSize: 'clamp(20px, 2.5vw, 28px)', fontWeight: 300, lineHeight: 1.2, marginBottom: 0, letterSpacing: '-0.02em' }}>
Six questions about how you currently vote.
</h3>
<div style={{ width: 36, height: 1, backgroundColor: 'rgba(232,168,32,0.35)', margin: '18px 0' }} />
<p style={{ color: 'rgba(245,240,232,0.55)', fontSize: 14, lineHeight: 1.65, marginBottom: 32 }}>
...
<button onClick={() => setStep(1)} style={{ backgroundColor: '#E8A820', color: '#0F1B1F', padding: '15px 40px', borderRadius: 2, fontWeight: 800, fontSize: 12, border: 'none', cursor: 'pointer', width: '100%', letterSpacing: '0.1em', textTransform: 'uppercase', fontFamily: 'inherit' }}>
Begin the civic mirror →
</button>
<p style={{ color: 'rgba(245,240,232,0.3)', fontSize: 11, textAlign: 'center', marginTop: 14, letterSpacing: '0.02em' }}>Takes about 3 minutes. Results sent to your email.</p>
</div>
</div>
</div>
</div>
...
style={{ textAlign: 'left', padding: '18px 22px', borderRadius: 8, fontSize: 15, lineHeight: 1.55, cursor: 'pointer', transition: 'all 0.15s', backgroundColor: selected === opt.value ? '#E8A820' : 'rgba(255,255,255,0.05)', color: selected === opt.value ? '#0F1B1F' : '#F5F0E8', border: `1.5px solid ${selected === opt.value ? '#E8A820' : 'rgba(232,168,32,0.15)'}`, fontWeight: selected === opt.value ? 600 : 400 }}>
{opt.label}
</button>
))}
</div>
...
<button type="submit" disabled={loading}
style={{ backgroundColor: '#E8A820', color: '#0F1B1F', padding: '18px', borderRadius: 6, fontWeight: 700, fontSize: 15, border: 'none', cursor: 'pointer', opacity: loading ? 0.7 : 1 }}>
...
<p style={{ color: '#F5F0E8', fontSize: 16, fontWeight: 500, marginBottom: 6 }}>{issuePriorities.map(k => ISSUE_LABELS[k] || k).join(' · ')}</p>
<p style={{ color: 'rgba(245,240,232,0.4)', fontSize: 13, lineHeight: 1.6 }}>
When you take the full alignment quiz at <a href="/align" style={{ color: '#E8A820', textDecoration: 'none' }}>/align</a>, questions in these areas will carry 2.5× weight in your match score.
</p>
</div>
)}
...
<h2 style={{ color: '#0F1B1F', fontSize: 'clamp(28px, 4vw, 48px)', fontWeight: 300, letterSpacing: '-0.025em', lineHeight: 1.15, marginBottom: 12 }}>Voter disengagement is not<br />a motivation problem.</h2>
<h2 style={{ color: '#0F1B1F', fontSize: 'clamp(28px, 4vw, 48px)', fontWeight: 300, letterSpacing: '-0.025em', lineHeight: 1.15, marginBottom: 48 }}>It is an <em>information architecture</em> problem.</h2>
</Reveal>
...
{i > 0 && <div style={{ position: 'absolute', left: -16, top: '50%', transform: 'translateY(-50%)', color: '#E8A820', fontSize: 20, fontWeight: 300 }}>→</div>}
...
<p style={{ color: 'rgba(245,240,232,0.35)', fontSize: 13, lineHeight: 1.6, maxWidth: 480, margin: '0 auto' }}>Every question is publicly audited. Every bias score is archived. You can read the full methodology before you answer anything.</p>
...
<p style={{ color: '#0F1B1F', fontSize: 'clamp(20px, 3.5vw, 34px)', fontWeight: 300, lineHeight: 1.4 }}>Democracy works when the information does.</p>
</div>
</section>
...
<h2 style={{ color: '#F5F0E8', fontSize: 'clamp(28px, 4vw, 48px)', fontWeight: 300, letterSpacing: '-0.02em', marginBottom: 64 }}>Three phases.<br />One civic mirror.</h2>
</Reveal>
{[
...
<h2 style={{ color: '#0F1B1F', fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 300, lineHeight: 1.2, letterSpacing: '-0.02em', marginBottom: 20 }}>The people this system harms most did not choose to be shut out.</h2>
<p style={{ color: 'rgba(15,27,31,0.7)', fontSize: 16, lineHeight: 1.75 }}>First-generation voters. Low-income voters. Communities where local journalism died years ago. People who tried civic participation and got nothing back for it. They were shut out by design, not by apathy.</p>
<p style={{ color: 'rgba(15,27,31,0.7)', fontSize: 16, lineHeight: 1.75, marginTop: 16 }}>GroundedVote was built for them first. It works for someone who has never followed an election closely. When they finish, they want to share it.</p>
</Reveal>
<Reveal delay={150}>
