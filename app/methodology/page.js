    ...
    <>
      ...
      <Section>
        ...
        <p style={{ color: S.muted, fontSize: 17, lineHeight: 1.75, maxWidth: 580, marginBottom: 0 }}>
          Transparency is the foundation of trust. Every element of the pipeline — question generation, bias auditing, candidate scoring, and match computation — is documented here and archived publicly.
        </p>
      </Section>
      ...
      <Section>
        ...
        {[
          ['Challenger candidates have less data', 'Congress.gov only provides records for current and former members of Congress. For challengers with no prior elected office, positions are inferred from public statements and party platforms with lower confidence.'],
          ['AI position inference is probabilistic', 'Even with strong source evidence, AI-assigned position scores are estimates, not verified candidate statements. Voters should use them as one signal among many, not as definitive fact.'],
          ['Coverage is limited to competitive federal races', 'For 2026, GroundedVote covers 35 Senate and House races selected for electoral competitiveness. State legislature, judicial, and local races are not yet included.'],
          ['Bias audit is not bias elimination', 'The 3-pass audit significantly reduces measurable framing bias. It does not eliminate it. Questions are better than unaudited alternatives, not perfect.'],
        ].map(([title, desc]) => (
